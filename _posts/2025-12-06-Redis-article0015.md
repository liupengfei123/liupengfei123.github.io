...
![image-20251206144113192]({{site.baseurl}}/img/in-post/article0015/image-20251206144113192.png)
...
![image-20251206144125544]({{site.baseurl}}/img/in-post/article0015/image-20251206144125544.png)

## 命令执行器（1）：查找命令实现
命令执行器要做的第一件事是根据客户端状态的argv[0]参数，在命令表（command table）中查找参数指定的命令（通过 redis.c 的 lookupCommand方法），并将其保存到客户端状态的cmd属性里。

![image-20251206144133622]({{site.baseurl}}/img/in-post/article0015/image-20251206144133622.png)
...
![image-20251206144157588]({{site.baseurl}}/img/in-post/article0015/image-20251206144157588.png)

## redisCommandProc定义与实现

redisCommandProc 的方法定义在 redis.h 文件中：

![image-20251206144216497]({{site.baseurl}}/img/in-post/article0015/image-20251206144216497.png)
